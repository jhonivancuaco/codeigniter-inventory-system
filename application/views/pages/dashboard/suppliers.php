<div class="container-fluid">
    ...
    <?php if ($this->session->flashdata('materials_redirect')) : ?>
        <div class="alert alert-danger text-center">
            <?php echo $this->session->flashdata('materials_redirect') ?>
        </div>
    <?php endif ?>
    ...
    <div class="card mt-4">
        <div class="card-body">
            ...
            <!-- Supplier Form -->
            <?php echo form_open(base_url('dashboard/suppliers'), ['id' => 'supplier-add-update-form']); ?>
    ...
    <div class="card d-none">
        <div class="card-body">
            <?php echo form_open(base_url('dashboard/suppliers'), ['id' => 'supplier-delete-form']); ?>
