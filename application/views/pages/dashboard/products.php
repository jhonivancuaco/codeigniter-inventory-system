<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            <table id="transactions-table" class="table table-striped small text-center w-100">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Product ID</th>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <?php echo form_open(site_url("dashboard/products"), ['id' => 'order-add-update-form']); ?>
            ...
            <div class="row">
                        ...
                        <select class="form-control" name="product_id" id="product_id">
                            ...
                            <?php foreach ($products as $product) : ?>
                                <option value="<?php echo $product->id; ?>" <?php echo set_select('product_id', $product->id); ?>>
                                    ID: <?php echo $product->id; ?> - Name: <?php echo $product->name; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="transaction_id">Transcation ID <small>(Auto Generated)</small></label>
